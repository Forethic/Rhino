...
using CustomerDatabaseTutorial.Repository;
using CustomerDatabaseTutorial.Views;
...
namespace CustomerDatabaseTutorial
{
    /// <summary>
    ...
    sealed partial class App : Application
    {
        ...
        {
            var demoDatabasePath = Package.Current.InstalledLocation.Path + @"\Assets\Repository.db";
            var databasePath = ApplicationData.Current.LocalFolder.Path + @"\CustomerDatabaseRepository.db";
